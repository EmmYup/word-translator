<template>
	<div class="row" id="translateForm">
	  <div class="col-md-6 col-md-offset-3">
		<form id="transForm" class=" form-inline well" @submit="formSubmit">
			<input class="form-control" type="text" v-model="textToTranslate" placeholder="Enter a word">
			<select class="form-control" v-model="lenguage">
...
export default {
  ...
  ,methods: {
  	formSubmit(e) {
  		this.$emit('formSubmit', this.textToTranslate, this.lenguage);
  		e.preventDefault();
  	}
  }
}
